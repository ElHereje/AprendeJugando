...
Ahora vamos a modificar el nivel fácil para no ganar con tanta
facilidad
...
def movimiento_ordenador_ia_parcial(palillos, quitas):
    # vamos a hacer que si se pueden quitar todos en el
    # último movimiento, lo quite
    if palillos <= quitas:
...
while jugando:
    ...
    if turno == 1:
        ...
        time.sleep(2)
        if nivel == "1":
            jugada = movimiento_ordenador_ia_parcial(palillos, quitas)
        elif nivel == "2":
