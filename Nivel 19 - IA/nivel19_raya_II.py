...
def movimiento_ordenador_facil(tablero, jugador):
    ...
    # poco eficiente, ya que tiene muchas líneas de código
    # en el siguiente archivo se verá una forma más eficiente
...
def movimiento_ordenador_dificil():
    pass
