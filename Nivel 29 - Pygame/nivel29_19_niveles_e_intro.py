...
nave_arr = pygame.image.load("./images/nave_arriba.png").convert_alpha()
...
while en_juego:
    ...
    while en_inicio:
        ...
        for frase in historia:
            ...
            y += 80  # cada frase a 80 px de distancia
    ...
    while en_partida:
        ...
        num_aste_grandes = num_nivel * 5 # nº de asteroides según nivel
